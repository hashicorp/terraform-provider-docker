		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					// Note: ports cannot be tested because the hash of the set adapts regarding to
					// the value of the random external port
					// resource.TestCheckResourceAttr("docker_container.foo", "ports.1347368482.internal", "80"),
					// resource.TestCheckResourceAttr("docker_container.foo", "ports.1347368482.ip", "0.0.0.0"),
					// resource.TestCheckResourceAttr("docker_container.foo", "ports.1347368482.protocol", "tcp"),
					// testValueHigherEqualThan("docker_container.foo", "ports.1347368482.external", 32768),
				),
			},
		},
	})
		...
		Steps: []resource.TestStep{
			resource.TestStep{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("docker_container.foo", "ports.2498386340.protocol", "tcp"),
					resource.TestCheckResourceAttr("docker_container.foo", "ports.2498386340.external", "32787"),
					resource.TestCheckResourceAttr("docker_container.foo", "ports.3536779401.internal", "81"),
					resource.TestCheckResourceAttr("docker_container.foo", "ports.3536779401.ip", "0.0.0.0"),
					resource.TestCheckResourceAttr("docker_container.foo", "ports.3536779401.protocol", "tcp"),
					resource.TestCheckResourceAttr("docker_container.foo", "ports.3536779401.external", "32788"),
				),
			},
		},
	})
